...
public class LinkingBooksTeleporter implements ITeleporter {
	...
	public LinkingBooksTeleporter(BlockPos pos, float rot) {
		this.pos = pos;
		this.rot = rot;
	}
	...
	public void placeEntity(World world, Entity entity, float yaw) {
		...
		//LinkingBooksPacketHandler.sendSetEntityVelocityRequest(((EntityPlayerMP) (entity)).connection.netManager, 0.0D,
				//0.0D, 0.0D);
